...
from app.routers import activity, auth, device, dogs, events, media, metrics, miniapp_config, music, push, schedule, sync, turn, user, voice_commands, websocket
...
app.include_router(miniapp_config.router)
